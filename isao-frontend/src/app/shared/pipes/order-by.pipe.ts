/*
	Taken from https://github.com/VadimDez/ngx-order-pipe, use it like this:
...
export class OrderPipe implements PipeTransform {
   ...
   * @param b
   */
  public static caseInsensitiveSort(a: any, b: any) {
   ...
   * @param b
   */
  public static defaultCompare(a: any, b: any) {
    if (a === b) {
      return 0;
    }
    if (a == null) {
   ...
   * @returns {string[]}
   */
  public static parseExpression(expression: string): string[] {
   ...
   * @returns {any}
   */
  public static getValue(object: any, expression: string[]) {
   ...
   * @param expression
   */
  public static setValue(object: any, value: any, expression: string[]) {
    let i;
  ...
  public transform(value: any | any[], expression?: any, reverse?: boolean, isCaseInsensitive = false, comparator?: Function): any {
    if (!value) {
      return value;
    }
   ...
   * @returns {any}
   */
  private multiExpressionTransform(value: any, expressions: any[], reverse: boolean, isCaseInsensitive = false, comparator?: Function): any {
